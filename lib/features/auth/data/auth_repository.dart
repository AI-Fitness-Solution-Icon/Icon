  ...
  Future<Map<String, dynamic>> signUpWithEmail(
    ...
    try {
      ...
      if (response.session == null) {
        ...
        return {'user': response.user, 'requiresEmailConfirmation': true};
      } else {
        // User is immediately authenticated (email confirmation not required)
        return {'user': response.user, 'requiresEmailConfirmation': false};
      }
  ...
  Future<app_user.User?> getCurrentUserAsync() async {
    try {
      ...
      if (supabaseUser != null) {
        return await _supabaseService.getUserProfile(supabaseUser);
      }
      return null;
    } catch (e) {
