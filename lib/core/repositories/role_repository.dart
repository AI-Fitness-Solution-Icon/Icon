...
class RoleRepository {
  ...
  Future<List<Role>> getAllRoles() async {
    try {
      ...
      AppPrint.printPerformance('Get all roles', DateTime.now().difference(startTime));
  ...
  Future<Role?> getRoleById(String roleId) async {
    try {
      ...
      AppPrint.printPerformance('Get role by ID', DateTime.now().difference(startTime));
  ...
  Future<Role?> getRoleByName(String roleName) async {
    try {
      ...
      AppPrint.printPerformance('Get role by name', DateTime.now().difference(startTime));
      AppPrint.printSuccess('Successfully fetched role: ${role.roleName}');
  ...
  Future<Role> createRole(String roleName) async {
    try {
      ...
      AppPrint.printPerformance('Create role', DateTime.now().difference(startTime));
  ...
  Future<Role?> updateRole(String roleId, String newRoleName) async {
    try {
      ...
      AppPrint.printPerformance('Update role', DateTime.now().difference(startTime));
  ...
  Future<bool> deleteRole(String roleId) async {
    try {
      ...
      AppPrint.printPerformance('Delete role', DateTime.now().difference(startTime));
  ...
  Future<List<Role>> getRolesWithPagination({
    ...
    try {
      AppPrint.printStep('Fetching roles with pagination (limit: $limit, offset: $offset)');
      final startTime = DateTime.now();
      ...
      AppPrint.printPerformance('Get roles with pagination', DateTime.now().difference(startTime));
      AppPrint.printSuccess('Successfully fetched ${roles.length} roles');
  ...
  Future<int> getRolesCount() async {
    try {
      ...
      AppPrint.printPerformance('Get roles count', DateTime.now().difference(startTime));
